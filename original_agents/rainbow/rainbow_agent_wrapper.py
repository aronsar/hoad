...
from original_agents.rainbow.rainbow_agent import RainbowAgent as _RainbowAgent
from original_agents.rainbow.run_experiment import format_legal_moves
from original_agents.rainbow.third_party.dopamine import checkpointer
import os

def checkpoint_stuff():
  base_dir = os.path.dirname(os.path.abspath(__file__))
  checkpoint_dir = os.path.join(base_dir, 'pretrained_model')
...
class Agent(_Agent):
  ...
  def __init__(self, config, *args, **kwargs):
    ...
    checkpoint_dir, checkpoint_version, dqn_dictionary = checkpoint_stuff()
